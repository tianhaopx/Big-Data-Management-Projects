...
public class P1 {
    ...
    public static void main(String[] args) {
        ...
        // for each group calculate the sum of total amounts, the average of total amounts, the min and the max of
        // the total amounts.
        ...
        // and for each group report the customer ID, and the transactions’ count.
...
//        SparkConf conf = new SparkConf().setAppName("P1").setMaster("local");
